from pyformlang.finite_automaton import DeterministicFiniteAutomaton as DFA, State as st, Symbol as sb
...
class Automaton(object):
    ...
    def set_up_final_states(self):
        ...
        for fn in [
            st(f"Salvaje final: {self.names['Protagonista']} es atacado por animales salvaje"),
            st(f"Devorado por la bestia: Era una bestia feroz, {self.names['Protagonista']} es devorado por ella"),
            st(f"Regreso Triunfante: {self.names['Protagonista']} descubre el tesoro, es rescatado y regresa como héroe"),
            st(f"Trampa mortal: {self.names['Protagonista']} Acciona accidentalmente una trampa mortal"),
            st(f"Alianza inusual: {self.names['Protagonista']} Establece una comunicación inusual con {self.names['Criatura']} y logra salir de la isla en compañía de {self.names['Criatura']}"),
            st(f"Ataque inesperado: {self.names['Protagonista']} es emboscado, atacado y asesinado por los nativos hostiles")
        ]:
    ...
    def set_up_automaton(self):
        ...
        q0_q2 = sb(f"Buscar refugio en el bosque {self.names['Bosque']}".replace(" ", "_"))
        ...
        q3_q8 = sb(f"Despertar a una criatura durmiente llamada {self.names['Criatura']}".replace(" ", "_"))

        q4_q9 = sb(f"Descubrir un cofre enterrado".replace(" ", "_"))
        q4_q10 = sb(f"Seguir a una tribu de nativos liderada por la jefa {self.names['Lider']}".replace(" ", "_"))
        ...
        q6_qfin2 = sb(f"Investigar un ruido extraño proveniente de los matorrales".replace(" ", "_"))
        q6_q12 = sb(f"Tratar de sobrevivir a la noche desde un único punto".replace(" ", "_"))
        ...
        q8_qfin5 = sb(f"Intentar comunicarte con {self.names['Criatura']}".replace(" ", "_"))

        q9_qfin3 = sb(f"Quedarse solo con el tesoro".replace(" ", "_"))
        q9_qfin4 = sb(f"Llevarse el tesoro y el cofre".replace(" ", "_"))

        q10_q14 = sb(f"Intentar negociar con la jefa {self.names['Lider']}".replace(" ", "_"))
        ...
        q12_qfin1 = sb(f"Permanecer en la isla {self.names['Isla']} como ermitaño llamado {self.names['Protagonista']}".replace(" ", "_"))

        q13_qfin3 = sb(f"Buscar comida alrededor de la cueva {self.names['Cueva']}".replace(" ", "_"))
        q13_qfin4 = sb(f"Tratar de entrar por el otro lado de la cueva {self.names['Cueva']}".replace(" ", "_"))

        q14_qfin3 = sb(f"Llegar a un acuerdo beneficioso con la jefa {self.names['Lider']}".replace(" ", "_"))
        q14_qfin6 = sb(f"Tratar de robar a los nativos".replace(" ", "_"))

        q15_qfin3 = sb(f"Esconderse en una embarcación".replace(" ", "_"))
        q15_qfin6 = sb(f"Correr hasta la costa en un intento desesperado por escapar".replace(" ", "_"))
